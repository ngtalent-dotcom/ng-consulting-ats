...
-- Vacante 1: Ejecutivo de Ventas / Didiamant
  ((SELECT id FROM vacantes WHERE titulo = 'Ejecutivo de Ventas'),   'Carlos',    'Mendoza',    'carlos.m@gmail.com',     '81 1111 2222', 'LinkedIn',    'Aplicó',              NULL, NULL,                   '',                                                  '2026-04-16 10:00:00+00'),
...
-- Vacante 2: Gerente de Tienda / Didiamant
  ...
  ((SELECT id FROM vacantes WHERE titulo = 'Gerente de Tienda'),     'Hector',    'Vazquez',    'hector.v@hotmail.com',   '81 7788 9900', 'Referido',    'Aplicó',               NULL, 'Pendiente',            '',                                                   '2026-05-10 10:00:00+00'),
...
-- Vacante 3: Analista de Credito / Coppel
  ...
  ((SELECT id FROM vacantes WHERE titulo = 'Analista de Credito'),   'Sofia',     'Hernandez',  'sofia.hdz@outlook.com',  '81 8899 0011', 'Indeed',      'Aplicó',               NULL, 'Pendiente',            '',                                                   '2026-05-18 10:00:00+00'),
...
-- Vacante 4: Ingeniero de Procesos / Ternium
  ...
  ((SELECT id FROM vacantes WHERE titulo = 'Ingeniero de Procesos'), 'Ivan',      'Guerrero',   'ivan.g@gmail.com',       '81 5544 3322', 'Indeed',      'Aplicó',               NULL, 'Pendiente',            '',                                                   '2026-05-20 10:00:00+00');
